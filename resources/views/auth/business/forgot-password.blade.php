...
mx-auto p-0">
    ...
    xl:p-10
    p-5">
            <form action="{{ route('auth.business.password.email') }}" method="post" autocomplete="on" aria-autocomplete="both"
                class="w-full">
                @csrf
                <!-- Session Status -->
                ...
                <div class="text-white text-center">
                    <a class="text-{{$site_settings->site_color_theme}} hover:text-red-500" href="{{route('auth.business.login')}}">Remembered your password? Login here</a>
                </div>
